<template>
    <div class="wizard-single-content builder-type">
        <div class="step-header">
            ...
            <p class="description">Choose which page builder or editor you want to use to design your funnel pages. WPFunnels is exclusively compatible with Gutenberg and Elementor with dedicated blocks and widgets. Also, get tons of amazing templates for both Gutenberg and Elementor for many different niches.</p>
        </div>
