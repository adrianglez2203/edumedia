            ...
            <div class="wpfnl-funnel-settings__wrapper">
                <nav class="wpfn-settings__nav">
                    <ul>
                        ...
                        <li class="nav-li <?php echo !$is_pro_activated ? ' disabled' : '' ?>" <?php echo $is_pro_activated ? ' data-id="facebook-pixel-setting" ' : '' ?> >
                            <svg id="Group_1" data-name="Group 1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                            <path id="Path_2" data-name="Path 2" d="M7,10v4h3v7h4V14h3l1-4H14V8a1,1,0,0,1,1-1h3V3H15a5,5,0,0,0-5,5v2H7" fill="none" stroke="#7a8b9a" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
                            </svg>

                            <span><?php echo __('Facebook Pixel', 'wpfnl'); ?></span>
                        ...
                        <li class="nav-li <?php echo !$is_pro_activated ? ' disabled' : '' ?>" <?php echo $is_pro_activated ? ' data-id="gtm-settings" ' : '' ?> >
                            <svg id="Group_2" data-name="Group 2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <path id="Path_4" data-name="Path 4" d="M17.788,5.108A9,9,0,1,0,21,12H13" fill="none" stroke="#7a8b9a" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"/>
                            </svg>
                ...
                <div class="wpfnl-funnel__single-settings offer" id="offer-settings">
                    <?php if( $is_pro_activated ){ ?>
                        ...
                        <h4 class="settings-title"><?php echo __('Offer Settings (Upsell / Downsell Order)', 'wpfnl'); ?></h4>
                ...
                <div class="wpfnl-funnel__single-settings facebook-pixel" id="facebook-pixel-setting">
					<?php if( $is_pro_activated ){ ?>
                ...
                <div class="wpfnl-funnel__single-settings gtm" id="gtm-settings">
					<?php if( $is_pro_activated ){ ?>
                ...
                <div class="wpfnl-funnel__single-settings utm" id="utm-settings">
					<?php if( $is_pro_activated ){ ?>

						<h4 class="settings-title">
                            <?php echo __('UTM Settings', 'wpfnl'); ?>
                            <a href="" target="_blank"  title="Guide On UTM Integration">
                                <?php include WPFNL_DIR . '/admin/partials/icons/doc-icon.php'; ?>
                            </a>
                        </h4>
