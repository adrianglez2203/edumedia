	...
	public function init() {
        ...
        $this->settings_modal_toggles  = array(
			...
			'advanced' => array(
				'toggles' => array(
					...
					'title'       => array(
						'title'    => esc_html__( 'Heading', 'wpfnl' ),
						'priority' => 50,
					),
					'field_label' => array(
						'title'    => esc_html__( 'Input Field Labels', 'wpfnl' ),
						'priority' => 55,
					),
					'form_field'  => array(
						'title'    => esc_html__( 'Input Fields', 'wpfnl' ),
						'priority' => 60,
					),
					'form_notice' => array(
						'title'    => esc_html__( 'Form Notice', 'wpfnl' ),
						'priority' => 65,
					),
					'column_label' => array(
						'title'    => esc_html__( 'Order Table Column Label', 'wpfnl' ),
						'priority' => 70,
					),
					'body'         => array(
						'title'             => esc_html__( 'Order Table Body ', 'wpfnl' ),
					...
					'table_row'    => array(
						'title'    => esc_html__( 'Order Table Row', 'wpfnl' ),
						'priority' => 85,
					),
					'table_cell'   => array(
						'title'    => esc_html__( 'Order Table Cell', 'wpfnl' ),
						'priority' => 90,
					),
					'payment_body'                  => array(
					...
					'radio_button'          => array(
						'title'    => esc_html__( 'Payment Radio Buttons', 'wpfnl' ),
						'priority' => 100,
					),
					'selected_radio_button' => array(
						'title'    => esc_html__( 'Payment Selected Radio Button', 'wpfnl' ),
						'priority' => 105,
					),
					'coupon_button'          => array(
						'title'    => esc_html__( 'Coupon Button', 'wpfnl' ),
						'priority' => 115,
					),
					'coupon_form'                  => array(
						'title'             => esc_html__( 'Coupon Form', 'wpfnl' ),
						'tabbed_subtoggles' => true,
						'sub_toggles'       => array(
							'p' => array(
								'name' => 'P',
		...
		$this->advanced_fields = array(
			'fonts'        => array(
				...
				'field_label' => array(
					'label'       => esc_html__( 'Field Label', 'wpfnl' ),
					'css'         => array(
				...
				'column_label' => array(
					'label'       => esc_html__( 'Column Label', 'wpfnl' ),
					'css'         => array(
			...
			'button'         => array(
				'button' => array(
					'label'           => esc_html__( ' Order Button', 'wpfnl' ),
					'css'             => array(
			...
			'form_field'   => array(
				'form_field'  => array(
					...
					'border_styles'   => array(
						'form_field'       => array(
							'label_prefix' => esc_html__( 'Fields', 'wpfnl' ),
							'css'          => array(
								'main' => array(
						...
						'form_field_focus' => array(
							'label_prefix' => esc_html__( 'Fields Focus', 'wpfnl' ),
							'css'          => array(
								'main' => array(
									'border_styles' => implode(
										',',
...
//						),
				...
				'form_notice' => array(
					'label'                  => esc_html__( 'Form Notice', 'wpfnl' ),
					'css'                    => array(
					...
					'background_color'       => array(
						'description' => esc_html__( 'Pick a color to fill the module\'s notice.', 'wpfnl' ),
					),
					'text_color'             => array(
						'description' => esc_html__( 'Pick a color to be used for the text written inside notice.', 'wpfnl' ),
					),
				...
				'table'      => array(
					'label'                  => esc_html__( 'Table', 'wpfnl' ),
					'css'                    => array(
						'main' => '%%order_class%% table.shop_table',
					),
					'background_color'       => array(
						'description' => esc_html__( 'Pick a color to fill the module\'s table.', 'wpfnl' ),
					),
					'font_field'             => false,
					'margin_padding'         => array(
						'css'             => array(
					...
					'border_styles'          => array(
						'table' => array(
							'label_prefix'      => esc_html__( 'Table', 'wpfnl' ),
							'css'               => array(
								'main' => array(
				...
				'table_row'  => array(
					'label'                  => esc_html__( 'Table Row', 'wpfnl' ),
					'css'                    => array(
						'main' => '%%order_class%% table.shop_table tr',
					),
					'background_color'       => array(
						'description' => esc_html__( 'Pick a color to fill the module\'s table row.', 'wpfnl' ),
					),
					'font_field'             => false,
					'margin_padding'         => array(
						'css'         => array(
					...
					'border_styles'          => array(
						'table_row' => array(
							'label_prefix'      => esc_html__( 'Table Row', 'wpfnl' ),
							'css'               => array(
								'main'      => array(
				...
				'table_cell' => array(
					'label'                  => esc_html__( 'Table Cell', 'wpfnl' ),
					'css'                    => array(
						'main' => '%%order_class%% table.shop_table tr th, %%order_class%% table.shop_table tr td',
					),
					'background_color'       => array(
						'description' => esc_html__( 'Pick a color to fill the module\'s table cell.', 'wpfnl' ),
					),
					'font_field'             => false,
					'margin_padding'         => array(
						'css'        => array(
					...
					'border_styles'          => array(
						'table_cell' => array(
							'label_prefix'      => esc_html__( 'Table Cell', 'wpfnl' ),
							'css'               => array(
								'main'      => array(
				...
				'radio_button'          => array(
					'label'                  => esc_html__( 'Radio Button', 'wpfnl' ),
					'css'                    => array(
						'main'        => '%%order_class%% #payment .wc_payment_method',
						'text_shadow' => '%%order_class%% #payment .wc_payment_method label',
					),
					'background_color'       => array(
						'description' => esc_html__( 'Pick a color to fill the module\'s radio buttons.', 'wpfnl' ),
					),
					'text_color'             => array(
						'description' => esc_html__( 'Pick a color to be used for the text written next to radio button.', 'wpfnl' ),
					),
					'box_shadow'             => array(
						'css' => array(
							'main' => '%%order_class%% #payment .wc_payment_method',
					...
					'border_styles'          => array(
						'radio_button' => array(
							'label_prefix' => esc_html__( 'Radio Button', 'wpfnl' ),
							'css'          => array(
								'main' => array(
				...
				'selected_radio_button' => array(
					'label'                  => esc_html__( 'Selected Radio Button', 'wpfnl' ),
					'css'                    => array(
					...
					'background_color'       => array(
						'description' => esc_html__( 'Pick a color to fill the module\'s selected radio button.', 'wpfnl' ),
					),
					'text_color'             => array(
						'description' => esc_html__( 'Pick a color to be used for the text written next to selected radio button.', 'wpfnl' ),
					),
					'box_shadow'             => array(
						'css' => array(
							'main' => '%%order_class%% #payment .wc_payment_method.et_pb_checked',
					...
					'border_styles'          => array(
						'selected_radio_button' => array(
							'label_prefix' => esc_html__( 'Selected Radio Button', 'wpfnl' ),
							'css'          => array(
								'main' => array(
				...
				'tooltip'               => array(
					'label'                  => esc_html__( ' Payment Section Tooltip', 'wpfnl' ),
					'css'                    => array(
						'main' => '%%order_class%% #payment div.payment_box',
					),
					'background_color'       => array(
						'description' => esc_html__( 'Pick a color to fill the module\'s tooltip.', 'wpfnl' ),
					),
					'font_field'             => array(
						'css'             => array(
				...
				'coupon'               => array(
					'label'                  => esc_html__( ' Coupon', 'wpfnl' ),
					'css'                    => array(
						'main' => '%%order_class%% .wpfnl-checkout .woocommerce-form-coupon-toggle .woocommerce-info',
					),
					'background_color'       => array(
						'description' => esc_html__( 'Pick a color to fill the module\'s coupon.', 'wpfnl' ),
					),
					'font_field'             => array(
						'css'             => array(
							'main' => '%%order_class%% .wpfnl-checkout .woocommerce-form-coupon-toggle .woocommerce-info, .wpfnl-checkout .woocommerce-form-coupon-toggle .woocommerce-info',
						),
						'font_size'       => array(
							'default'        => '',
							'allowed_values' => et_builder_get_acceptable_css_string_values( 'width' ),
			...
			'margin_padding' => array(
				...
				'label_prefix'    => esc_html__( 'Heading', 'wpfnl' ),
				'tab_slug'        => 'advanced',
				'toggle_slug'     => 'title',
			),
			'borders' =>array(
		...
		$this->custom_css_fields = array(
			'title_text'  => array(
				'label'    => esc_html__( 'Heading Text', 'wpfnl' ),
    ...
    public function get_fields() {
        return array(
            'layout'             => array(
                ...
                'type'             => 'select',
                'options'          => array(
                    'wpfnl-col-1'       => et_builder_i18n( '1 column' ),
                    'wpfnl-col-2'       => et_builder_i18n( '2 column' ),
                    'wpfnl-multistep'   => et_builder_i18n( 'Multistep' ),
                ),
                'priority'         => 80,
                'default'          => 'wpfnl-col-2',
