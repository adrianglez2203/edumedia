...
class WPFNL_OptIN extends ET_Builder_Module {
	...
	public function init() {
		...
		$this->settings_modal_toggles  = array(
			'general'  => array(
				'toggles' => array(
					'main_content' => esc_html__( 'Form Layout', 'wpfnl' ),
					'form_field'     => esc_html__( 'Form Fields', 'wpfnl' ),
					'button'     => esc_html__( 'Button', 'wpfnl' ),
					'ac_submit'     => esc_html__( 'Actions After Submit', 'wpfnl' ),
				),
			),
		);
	...
	function get_advanced_fields_config() {
		...
		$advanced_fields['fonts']['quote'] = array(
			'label'    => esc_html__( 'Blockquote', 'wpfnl' ),
			'css'      => array(
		...
		$advanced_fields['borders']['title'] = array(
			...
			'label_prefix'    => esc_html__( 'Title', 'wpfnl' ),
			'tab_slug'        => 'advanced',
			'toggle_slug'     => 'title',
		);
		...
		$advanced_fields['button'] = array(
			'button' => array(
				...
				'css'   => array(
					'alignment'   => "%%order_class%% .btn-default",
				),
				'margin_padding' => false,
			),
			'margin_padding'  => array(
				'label' => esc_html__( 'Spacing', 'wpfnl' ),
				'css' => array(
					'padding'   => "{$this->main_css_element}_wrapper {$this->main_css_element}, {$this->main_css_element}_wrapper {$this->main_css_element}:hover",
					'margin'    => "{$this->main_css_element}_wrapper {$this->main_css_element}, {$this->main_css_element}_wrapper",
					'important' => 'all',
				),
			),
		);
	...
	public function get_fields() {
		return array(
			'layout'             => array(
				...
				'type'             => 'select',
				'options'          => array(
					''       			=> et_builder_i18n( 'Default Style' ),
					'form-style1'       => et_builder_i18n( 'Form Style-1' ),
					'form-style2'       => et_builder_i18n( 'Form Style-2' ),
					'form-style3'   	=> et_builder_i18n( 'Form Style-3' ),
					'form-style4'   	=> et_builder_i18n( 'Form Style-4' ),
				),
				'priority'         => 80,
				'default'          => '',
				'default_on_front' => '',
			...
			'first_name'       => array(
				'label'            => esc_html__( 'Enable First Name', 'wpfnl' ),
				'description'      => esc_html__( 'Enable First  Name', 'wpfnl' ),
				'type'             => 'yes_no_button',
			...
			'last_name'       => array(
				'label'            => esc_html__( 'Enable Last Name', 'wpfnl' ),
				'description'      => esc_html__( 'Enable Last Name', 'wpfnl' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
					'off' => et_builder_i18n( 'No' ),
			...
			'acceptance_checkbox'       => array(
				...
				'description'      => esc_html__( 'Acceptance checkbox', 'wpfnl' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
					'off' => et_builder_i18n( 'No' ),
			...
			'acceptance_checkbox_text'       => array(
				...
				'description'      => esc_html__( 'Acceptance text', 'wpfnl' ),
				'type'             => 'text',
			...
			'input_fields_icon'       => array(
				'label'            => esc_html__( 'Input Field Icon', 'wpfnl' ),
				'description'      => esc_html__( 'Input Field Icon', 'wpfnl' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
					'off' => et_builder_i18n( 'No' ),
			...
			'field_label'       => array(
				...
				'description'      => esc_html__( 'Field Label', 'wpfnl' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
					'off' => et_builder_i18n( 'No' ),
			...
			'field_required_mark'       => array(
				'label'            => esc_html__( 'Field Required Mark', 'wpfnl' ),
				'description'      => esc_html__( 'Field Required Mark', 'wpfnl' ),
				'type'             => 'yes_no_button',
				'option_category'  => 'configuration',
				'options'          => array(
					'off' => et_builder_i18n( 'No' ),
			...
			'button_text' => array(
				...
				'description'     => esc_html__( 'Input your desired button text, or leave blank for no button.', 'wpfnl' ),
				'toggle_slug'     => 'button',
				'default'         => 'Submit',
				'computed_affects' => array(
					'layout',
			...
			'admin_email'       => array(
				...
				'description'      => esc_html__( 'Admin Email', 'wpfnl' ),
				'type'             => 'text',
				'default'          => '',
				'default_on_front' => '',
			...
			'admin_email_subject'       => array(
				...
				'description'      => esc_html__( 'Admin Email Subject', 'wpfnl' ),
				'type'             => 'text',
				'default'          => '',
				'default_on_front' => '',
				'toggle_slug'      => 'ac_submit',
			...
			'notification_text'       => array(
				...
				'description'      => esc_html__( 'Notification text', 'wpfnl' ),
				'type'             => 'text',
				'default'          => '',
				'default_on_front' => '',
				'toggle_slug'      => 'ac_submit',
			...
			'other_action'             => array(
				...
				'description'      => esc_html__( 'Other action', 'wpfnl' ),
				'type'             => 'select',
				'options'          => array(
					'notification'    => et_builder_i18n( 'None' ),
					'redirect_to'     => et_builder_i18n( 'Redirect to url' ),
					'next_step'       => et_builder_i18n( 'Next Step' ),
				),
				'priority'         => 80,
			...
			'redirect_url'       => array(
				...
				'description'      => esc_html__( 'Redirect url', 'wpfnl' ),
				'type'             => 'text',
				'default'          => '',
				'default_on_front' => '',
				'toggle_slug'      => 'ac_submit',
