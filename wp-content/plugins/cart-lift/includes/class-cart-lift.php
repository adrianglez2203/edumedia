...
class Cart_Lift
{
    ...
    private function define_admin_hooks()
    {
	    ...
	    if( $cl_db_version !== '4.0' ) {
		    $this->loader->add_action( 'plugins_loaded', $cl_db_action, 'cl_update_database' );
	    }

        $this->loader->add_action( 'admin_notices', $plugin_admin, 'show_paddle_notice' );
    ...
    private function define_public_hooks()
    {
        ...
        $this->loader->add_action( 'edd_payment_save', $edd_action, 'action_payment_save', 10, 2);
        $this->loader->add_action( 'edd_payment_saved', $edd_action, 'update_cart_status_edd', 10, 2 );
        $this->loader->add_action( 'edd_purchase_form_after_email', $edd_action, 'purchase_form_after_email', 99999, 1 );
