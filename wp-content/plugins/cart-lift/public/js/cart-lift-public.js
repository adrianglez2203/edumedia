    ...
    CartLiftCheckout = {
        init: function () {
            if ( cl_localized_vars.gdpr === '1' ) {
                $( ".woocommerce-billing-fields__field-wrapper #billing_email" ).after( "<span id='cl_gdpr_message'> <span> " + cl_localized_vars.gdpr_messages + " <a style='cursor: pointer' id='cl_gdpr_no_thanks'>No thanks</a></span></span>" );
                $( "#edd-email" ).after( "<span id='cl_gdpr_message'> <span style='font-size: xx-small'> " + cl_localized_vars.gdpr_messages + " <a style='cursor: pointer' id='cl_gdpr_no_thanks'>No thanks</a></span></span>" );
            }
