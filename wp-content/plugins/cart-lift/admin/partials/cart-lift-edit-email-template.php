...
<!--                        --><?php
//                          if (in_array('wpfunnels/wpfnl.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ))) {
//                            ?>
<!--                            <tr>-->
<!--                                <th>-->
<!--                                    <label>--><?php //esc_html_e( 'Enable Funnel?', 'cart-lift' ); ?><!--</label>-->
<!--                                </th>-->
<!--                                <td class="cl-checkbox">-->
<!--                                    --><?php
//                                        $checked = '';
...
//                                        }
//                                    ?>
<!--                                    <input class="cl-toggle-campaign-funnel" id="cl-campaign-funnel" name="cl_campaign_funnel" type="checkbox" --><?php //echo $checked; ?><!-- value="--><?php //echo $coupon; ?><!--" />-->
<!--                                    <label for="cl-campaign-funnel">--><?php //echo __('Allows you to detect rejected sells from funnel', 'cart-lift'); ?><!--</label>-->
<!--                                </td>-->
<!--                            </tr>-->
<!--                            --><?php
//                          }
