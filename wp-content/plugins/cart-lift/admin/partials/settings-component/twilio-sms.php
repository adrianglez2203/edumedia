<h4 class="settings-tab-heading">
    <?php echo __( 'SMS Notification', 'cart-lift' ); ?>
</h4>
...
<div class="inner-wrapper">
	...
	if ( !apply_filters( 'is_cl_premium', false ) ) {
        ...
        <span class="title"><?php
	        echo __( 'Enable Twilio SMS Notification:', 'cart-lift' ); ?></span>
            <span class="cl-switcher">
                <a href="https://rextheme.com/cart-lift?cl-dashboard=1" style="right: 48px" target="_blank" title="<?php _e( 'Click to Upgrade Pro', 'cart-lift' ); ?>" class="pro-tag">
