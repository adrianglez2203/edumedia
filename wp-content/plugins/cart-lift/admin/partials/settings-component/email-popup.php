<h4 class="settings-tab-heading">
    <?php echo __( 'Email Popup', 'cart-lift' ); ?>
</h4>
	...
	if ( !apply_filters( 'is_cl_premium', false ) ) {
        ...
        <div class="cl-form-group">
            <span class="title"><?php
				echo __( 'Enable Cart Lift Popup:', 'cart-lift' ); ?></span>
            ...
            <div class="tooltip">
                ...
                <p><?php
					echo __( 'This will initiate a pop-up and prompt users to provide email addresses when they intend to leave from the cart page.', 'cart-lift' ); ?></p>
            </div>
        </div>
		<?php
	}
